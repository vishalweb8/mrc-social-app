                    ...
                    <div class="box-body">
                        ...
                        @if(isset($data) && !empty($data))
                            <div class="form-group" id="business_images">
                                ...
                                <div class="col-sm-8">
                                    @if($data->logo != '' && Storage::disk(config('constant.DISK'))->exists(Config::get('constant.SERVICE_THUMBNAIL_IMAGE_PATH').$data->logo))
                                        <img src="{{ Storage::disk(config('constant.DISK'))->url(Config::get('constant.SERVICE_THUMBNAIL_IMAGE_PATH').$data->logo) }}" width="50" height="50"/>
                                    @else
                                ...
                                <div class="form-group" id="business_images">
                                    ...
                                    <div class="col-sm-4">
                                            @forelse($data->serviceImages as $image)
                                                @if(Storage::disk(config('constant.DISK'))->exists(Config::get('constant.SERVICE_THUMBNAIL_IMAGE_PATH').$image['image_name'])) 
                                                    ...
                                                    <i class="fa fa-times-circle" aria-hidden="true" onclick="return deleteServiceImage({{$image['id']}});"></i>
                                                        <img src="{{ Storage::disk(config('constant.DISK'))->url(Config::get('constant.SERVICE_THUMBNAIL_IMAGE_PATH').$image['image_name']) }}" width="50" height="50"/>
                                                    </div>
                                                @endif                                                
                                            @empty
                                           @endforelse
