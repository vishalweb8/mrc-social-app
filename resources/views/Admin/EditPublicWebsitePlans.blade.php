			...
			<div class="box">
				<div class="box-header with-border">
			        ...
			        @if(Session::has('success'))
				        ...
				        @endif
					<form id="addinvestment" class="form-horizontal" method="post" action="{{route('PublicWebsiteplans.update',$PublicWebsitePlans->id)}}" enctype="multipart/form-data" novalidate="novalidate">
						@csrf
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" id="plan_name " name="pw_plan_name" placeholder="Plan Name" value="{{ $PublicWebsitePlans->pw_plan_name }}" >
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<textarea type="file" class="form-control" id="website_name" name="plan_features" placeholder="Plan Features" >
										{{ $PublicWebsitePlans->pw_plan_features }}
									</textarea>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" id="website_name" name="plan_amount"  value="{{ $PublicWebsitePlans->pw_plan_amount }}" >
							...
							<div class="form-group">
								<label for="title" class="col-sm-2 control-label">Plan Duration<span class="star_red">*</span></label>
								<div class="col-sm-8">
									<input type="text" class="form-control" id="plan_duration" name="plan_duration" placeholder="Plan Duration" value="{{ $PublicWebsitePlans->pw_plan_duration }}" >
