		...
		<div class="col-md-12">
			...
			<div class="box">
				<div class="box-header with-border">
					<h3 class="box-title">{{trans('labels.addbtn')}} {{trans('labels.business_branding_inquiry')}}</h3>
					</div><!-- /.box-header -->
					 @if(Session::has('success'))
				        ...
				        @endif
					<form  class="form-horizontal" method="post" action="{{route('businessBrandingInquiry.store')}}" enctype="multipart/form-data" novalidate="novalidate">
