				...
				<div class="box-header with-border">
					<h3 class="box-title">Add Public Website Payments</h3>
					   ...
					   @if(Session::has('success'))
				        ...
				        @endif
					<form id="addinvestment" class="form-horizontal" method="post" action="{{route('PublicWebsitepayments.save')}}" enctype="multipart/form-data" novalidate="novalidate">
						@csrf
						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" id="website_name" name="amount" placeholder="Amount" value="{{ old('amount') }}">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="date" class="form-control" id="website_name" name="date" placeholder="Date"  value="{{ old('date') }}">
									@if ($errors->has('date'))
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" id="website_name" name="pay_trans_id" placeholder="Payment Transaction Id" value="{{ old('pay_trans_id') }}" >
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" id="website_name" name="payment_message" placeholder="Enter Payment Message" value="{{ old('payment_message') }}" >
