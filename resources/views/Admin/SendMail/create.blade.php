				...
				<div class="box-header with-border">
					<h3 class="box-title">{{trans('labels.send_mail')}}</h3>
					 ...
					 @if(Session::has('success'))
				        ...
				        @endif
					<form  class="form-horizontal" method="post" action="{{route('sendMail.store')}}" enctype="multipart/form-data" novalidate="novalidate">
						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control" id="start_id" name="start_id" placeholder="Start Id" value="{{ old('start_id') }}">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control" id="end_id" name="end_id" placeholder="End Id" value="{{ old('end_id') }}">
